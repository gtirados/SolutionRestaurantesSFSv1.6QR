...
pub_cadena = "SELECT * FROM PEDIDOS WHERE PED_CODCIA = ? and PED_fecha >= ? and PED_fecha <= ? and PED_FAMILIA = 2 AND PED_CANATEN = 0 AND PED_ESTADO <> 'E'"
...
pub_cadena = "SELECT DISTINCT PED_CODART  FROM PEDIDOS WHERE PED_CODCIA = ? and PED_fecha >= ? and PED_fecha <= ? and PED_FAMILIA = 2 AND PED_CANATEN = 0 AND PED_ESTADO <> 'E'"
...
pub_cadena = "SELECT PED_CANTIDAD,PED_CODCLIE,PED_HORA,PED_CODVEN FROM PEDIDOS WHERE PED_CODCIA = ? AND PED_FECHA >= ? AND PED_FECHA <= ? AND  PED_CODART = ? AND  PED_ESTADO <> 'E' and PED_FAMILIA = 2 AND PED_CANATEN = 0 ORDER BY PED_HORA ASC"
...
pub_cadena = "SELECT sum(PED_CANTIDAD) as total  FROM PEDIDOS WHERE PED_CODCIA = ? AND PED_FECHA >= ? AND PED_FECHA <= ?  AND  PED_CODART = ? AND PED_ESTADO <> 'E' and PED_FAMILIA = 2 AND PED_CANATEN = 0 AND PED_ESTADO <> 'E'"
