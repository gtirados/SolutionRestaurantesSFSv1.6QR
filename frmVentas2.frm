...
'Private pRSfp As ADODB.Recordset
...
Private Sub cmdGrabar_Click()
    ...
    If oRSfp.RecordCount <> 0 Then
        ...
        If oRSfp.RecordCount <> 0 And Len(Trim(Me.txtRuc.Tag)) = 0 Then
            MsgBox "Debe elegir un cliente", vbInformation, Pub_Titulo
            oRSfp.Filter = ""
            oRSfp.MoveFirst
            Exit Sub
            Else
        ...
        If IsNumeric(Me.txtCliente.Text) Then
            If Len(Trim(Me.txtCliente.Text)) = 11 Then
                ...
                xsalida = 0
                    ...
                    oCmdEjec.Parameters.Append oCmdEjec.CreateParameter("@RAZONSOCIAL", adVarChar, adParamInput, 200, Left(Trim(frmFacComandaSunat.gRS), 200))
                    oCmdEjec.Parameters.Append oCmdEjec.CreateParameter("@DIRECCION", adVarChar, adParamInput, 200, Left(Trim(frmFacComandaSunat.gDIR), 200))
...
'    End If
    ...
    For Each crParamDef In crParamDefs
        ...
        Select Case crParamDef.ParameterFieldName
            ...
            Case "subtotal"
                crParamDef.AddCurrentValue FormatNumber(Me.lblSubTotal.Caption, 2)
            Case "igv"
                crParamDef.AddCurrentValue FormatNumber(Me.lblIgv.Caption, 2)
            Case "SerFac"
