...
Private Sub cmd_AddItem_Click()
    ...
    sCnnSQL = "Provider=SQLOLEDB.1;Persist Security Info=False;pwd=" & wAcceso & ";User ID=sa;Initial Catalog=bdatos;Data Source=laptop" '"Provider=MSDASQL;Data Source=dsn_datos" '"provider=SQLOLEDB;Data source=PC01;initial catalog=bdatos;password=;user id=sa"
