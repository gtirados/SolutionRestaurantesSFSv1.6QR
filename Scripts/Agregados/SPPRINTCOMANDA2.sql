...
GO
/*
exec SpPrintComanda2 '01','100',273,'22,15,7586,9,172,23,172,8,17,7606,','0,3,4,5,9,1,6,7,8,2,',1,' '

exec SpPrintComanda2 '01','100',277,'27,18,172,174,28,7586,13,11,66,66,','0,3,8,9,4,5,6,7,10,11,'
*/
...
BEGIN
    ...
    BEGIN
        ...
        SELECT PEDIDOS.PED_FECHA,
			   ...
			   CASE WHEN PEDIDOS.PED_PADRE IS NULL THEN '' ELSE '=> ' END + RTRIM(LTRIM(ARTI.ART_NOMBRE)),
...
BEGIN
    ...
    BEGIN
        ...
        ORDER BY
            -- Agrupa por el padre (si es hijo, toma PED_PADRE, si es padre su propio PED_NUMSEC)
            CASE
                WHEN PEDIDOS.PED_PADRE IS NULL THEN
                    PEDIDOS.PED_NUMSEC
                ELSE
                    PEDIDOS.PED_PADRE
            END,
